    <?php
        ...
        function createTable(){
            ...
            $tableUser = "create table if not exists User(
                ...
                address varchar(40) ,
                phone varchar(15),
                bithdate Date)" ; //image dataType ?? complete here
        ...
        $phone, $birthdate ){ //add image to parameters
            global $conn;
            ...
            if(select("*","username = '$username' ")===true){
                ...
                '$lastName', '$password', '$address', '$phone', '$birthdate')") ){//add image to parameters
        ...
        createTable();
        insert("usersr2w1", "user@email.com", "nour", "tarek", "1234", "faisal", "01234567890", 
        "02-01-2003");
        // select("username");
